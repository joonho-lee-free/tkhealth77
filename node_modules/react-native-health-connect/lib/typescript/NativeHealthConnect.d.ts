...
import type { HealthConnectRecord, Permission, WriteExerciseRoutePermission } from './types';
...
export interface Spec extends TurboModule {
    ...
    requestPermission(permissions: (Permission | WriteExerciseRoutePermission)[]): Promise<Permission[]>;
